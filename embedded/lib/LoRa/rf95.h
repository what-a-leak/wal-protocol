...
/**
 * Took from the RF95 library developped by Seeed-Studio
 * Git: https://github.com/Seeed-Studio/Grove_LoRa_433MHz_and_915MHz_RF/
 */
#define DEFAULT_TIMEOUT 3
#define RH_WRITE_MASK   0x80

/**
 * All these information can be read from the datasheet of the RFM95/96/97/98
 * The ATMega168 enables us to communicate through UART instead of SPI.
 * It has a specific set of protocol to update the registers of the RFM module.
 */

// 32 MHz / 2^19 = Resolution Frequency (cf: page 103)
#define F_RES ((32*1000000.0)/(1 << 19))
